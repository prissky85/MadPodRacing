...
class Player {
    ...
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            int xCorrection1 = (xMy1Past != 0) ? (xMy1 - xMy1Past) : 0; System.err.println("xCorrection1: " + xCorrection1);
            int yCorrection1 =  (yMy1Past != 0) ? (yMy1 - yMy1Past) : 0; System.err.println("yCorrection1: " + yCorrection1);
            int xCorrectedGoal1 = xNextCp1 - xCorrection1; System.err.println("xCorrectedGoal1: " + xCorrectedGoal1);
            int yCorrectedGoal1 = yNextCp1 - yCorrection1; System.err.println("yCorrectedGoal1: " + yCorrectedGoal1);
            ...
            int xCorrection2 =  (xMy2Past != 0) ? (xMy2 - xMy2Past) : 0; System.err.println("xCorrection2: " + xCorrection2);
            int yCorrection2 =  (yMy2Past != 0) ? (yMy2 - yMy2Past) : 0; System.err.println("yCorrection2: " + yCorrection2);
            int xCorrectedGoal2 = xNextCp2 - xCorrection2; System.err.println("xCorrectedGoal2: " + xCorrectedGoal2);
            int yCorrectedGoal2 = yNextCp2 - yCorrection2; System.err.println("yCorrectedGoal2: " + yCorrectedGoal2);

            String thrust2 = getThrust(nextCheckpointDist2, angleDifference(angleMy2, angleToCp2), formerDistToCP2);

            if (boost) {
                thrust(xCorrectedGoal1, yCorrectedGoal1, "100");
                thrust(xHis1, yHis1, "BOOST"); // Attack
                boost = false;
                continue;
            }

            thrust(xCorrectedGoal1, yCorrectedGoal1, thrust1);
            thrust(xCorrectedGoal2, yCorrectedGoal2, thrust2);
    ...
    public static void thrust(int nextCheckpointX, int nextCheckpointY, String thrust) {
